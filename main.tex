...
\hspace{2cm} 
\faIcon{at} \href{mailto:bjs.misra@outlook.com}
{bjs.misra@outlook.com}
\end{center}
...
\section*{How to use?}
I am summarizing biblatex package. Items are arranged in alphabetical orders--following original document--making items easier to find. You can also click \textquotedblleft \textbf{Cltr/Command + F}\textquotedblright in Windows/Mac and search using keywords to find each items quickly.

This file allow you to copy the code and use without adding additional code to work properly. Copying formats in this document is also easy. You can simply highlight code that you need and copy by clicking \textquotedblleft \textbf{Ctrl/Command + C}\textquotedblright in Windows/Mac. You may see page numbers included if codes are spread in multiple pages--just delete the page number copied with code.

\section*{Some Useful Hints}
\begin{itemize}
    \item \verb|author = {{US Forest Service}}| and \verb|(\cite{USFS2020})| \textbf{give} (\cite{USFS2020})
    \item \verb|(\cite{mishra2018})| \textbf{gives} (\cite{mishra2018})
    \item \verb|(\cite{m23a, m23b})| \textbf{gives} (\cite{m23a, m23b})
    \item \verb|\parencite{mishra 2019}| \textbf{gives} \parencite{mishra2019}
    \item \verb|\cite{mishra2018, mishra2019}| \textbf{gives} \cite{mishra2018, mishra2019}
    \item \verb|\textcite{mishra2018}| \textbf{gives} \textcite{mishra2018}
    \item Format link retrieved date as \verb|urldate = {2024-07-26}|.
\end{itemize}
